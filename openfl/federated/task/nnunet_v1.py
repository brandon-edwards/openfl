...
def train_nnunet(epochs,
    ...
    # Below is argument parsing code that i have instead incorporated into the main function params above
...
if __name__ == "__main__":
    train_nnunet(network=network, network_trainer=network_trainer, task=task, fold=fold)
